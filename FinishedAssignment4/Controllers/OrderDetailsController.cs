...
namespace FinishedAssignment4.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrderDetailsID,OrderID,ProductID,Quantity,LineNumber")] OrderDetails orderDetails)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderDetailsID,OrderID,ProductID,Quantity,LineNumber")] OrderDetails orderDetails)
        {
            if (ModelState.IsValid)
            {
